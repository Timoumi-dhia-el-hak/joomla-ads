...
<div class="juloawrapper">
    ...
    <form action="<?php echo $link; ?>" id="modsimplesearch-form" method="post">
        <div id="adsmanager_search_filed" class="row-fluid adsmanager_search_module<?php echo $moduleclass_sfx; ?>">
            ...
            <div class="<?php echo $class; ?>">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <button type="submit"  class="btn btn-search fa fa-search " value="<?php echo JText::_('ADSMANAGER_SEARCH_BUTTON'); ?>" />
                        </div>
                </div>
            </div>
