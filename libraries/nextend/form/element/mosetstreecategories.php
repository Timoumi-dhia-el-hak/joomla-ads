...
class NextendElementMosetstreecategories extends NextendElementList
{

    function fetchElement()
    {
        $db    = JFactory::getDBO();
        $query = 'SELECT cat_id AS id, cat_name AS title, cat_parent AS parent_id FROM #__mt_cats ORDER BY title ASC, ordering DESC';
        $db->setQuery($query);
