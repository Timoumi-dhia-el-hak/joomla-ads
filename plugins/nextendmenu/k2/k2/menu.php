...
class NextendTreeK2 extends NextendTreebaseJoomla {
    ...
    function initConfig() {
        ...
        $this->_config['orderitems'] = $this->_data->get('orderitems', '0');
    ...
    function getAllItems() {
        ...
        if ($this->_config['showproducts']) {
            ...
            if ($this->_config['orderitems'] == "asc") {
                $query.="ORDER BY a.title ASC";
            } else if ($this->_config['orderitems'] == "desc") {
                $query.="ORDER BY a.title DESC";
            } else if ($this->_config['orderitems'] == "dateasc") {
                $query.="ORDER BY a.created ASC";
            } else if ($this->_config['orderitems'] == "datedesc") {
