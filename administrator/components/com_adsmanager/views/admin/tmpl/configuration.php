...
<?php
echo $tabs->endPanel();
echo $tabs->startPanel(JText::_('ADSMANAGER_TAB_ALERTS'), "alert-page");
?>
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	<tr>
		<td></td>
	...
	<tr>
		<td><?php echo JText::_('ADSMANAGER_ALERT_EMAIL_SUBJECT'); ?></td>
		<td>
			<input type="text" name="params_alert_email_subject" value="<?php echo @htmlspecialchars($this->conf->alert_email_subject); ?>" />
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><?php echo JText::_('ADSMANAGER_ALERT_EMAIL_BODY'); ?></td>
		<td>
			<?php echo $editor->display( 'params_alert_email_body', @$this->conf->alert_email_body , '100%', '350', '75', '20' ) ; ?>
        </td>
		<td>&nbsp;</td>
	</tr>
</table>   
