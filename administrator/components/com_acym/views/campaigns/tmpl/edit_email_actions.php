<div class="cell grid-x text-center acym__campaign__email__save-button">
	...
	<div class="cell medium-auto grid-x text-right">
        ...
        <?php if (!empty($data['campaignID'])) { ?>
			<button <?php echo $data['before-save']; ?> data-task="save" data-step="listing" type="submit" class="cell button-secondary medium-shrink button medium-margin-bottom-0 margin-right-1 acy_button_submit">
