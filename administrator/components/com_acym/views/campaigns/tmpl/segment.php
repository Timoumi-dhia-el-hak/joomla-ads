			...
			<div class="cell grid-x acym__campaigns__segment__edit margin-top-1">
				...
				<div class="cell grid-x padding-1">
					<div class="cell grid-x acym_vcenter">
						...
						<div class="cell large-2 medium-4"><?php echo acym_select($data['segments'], 'segment_selected', empty($data['campaign']->sending_params['segment']['segment_id']) ? '' : $data['campaign']->sending_params['segment']['segment_id'], 'class="acym__select"'); ?></div>
					</div>
						...
						<div class="cell grid-x acym__content margin-bottom-1 acym__campaigns__segment__edit__filters">
							<div class="acym__campaigns__segment__edit__filters__save">
								...
								<div class="acym__campaigns__segment__edit__filters__save-action grid-x acym_vcenter align-right">
									<label for="acym__campaigns__segment__edit__filters__save-segment-name" class="cell shrink"><?php echo acym_translation('ACYM_SEGMENT_NAME'); ?>:</label>
									...
									<button type="button" class="button cell shrink acym__campaigns__segment__edit__filters__save-action-save"><?php echo acym_translation('ACYM_SAVE'); ?></button>
							...
							<input type="hidden" id="acym__segments__filters" value="<?php echo acym_escape(empty($data['campaign']->sending_params['segment']['filters']) ? '' : $data['campaign']->sending_params['segment']['filters']); ?>">
