<form id="acym_form" action="<?php echo acym_completeLink(acym_getVar('cmd', 'ctrl')); ?>" method="post" name="acyForm">
	<div id="acym__email__new" class="cell grid-x grid-margin-y align-center acym__content margin-top-2 acym__selection">
		...
		<div class="cell grid-x grid-margin-x align-center">
			<h2 class="cell small-12 margin-bottom-1 acym__selection__title text-center"><?php echo acym_translation('ACYM_NEWSLETTERS'); ?></h2>
		...
		<div class="cell grid-x grid-margin-x align-center">
            ...
            <?php if (acym_isAllowed('mails')) { ?>
                ...
                foreach ($extraBlocks as $oneExtra) {
                    ...
                    ?>
					<div class="acym__selection__card acym__selection__select-card cell large-2 medium-4 text-center" acym-data-link="<?php echo $oneExtra['link']; ?>">
